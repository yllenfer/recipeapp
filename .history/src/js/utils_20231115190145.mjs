...
// Define a variable to keep track of whether the recipes have been loaded
...
const displayRecipes = async () => {
    ...
    try {
        ...
        // Check if recipes have already been loaded
        if (!recipesLoaded) {
            // If not loaded, make the API call
            recipesData = await fetchRecipes();

            // Set the flag to indicate that recipes have been loaded
            recipesLoaded = true;
        }
        ...
        // Assuming recipesData is an array, you can customize this based on the actual structure
        const recipeHtml = recipesData.map(recipe => `
