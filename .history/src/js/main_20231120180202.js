...
// Assuming loadHeaderFooter returns a Promise
loadHeaderFooter().then(setupSearch);
...
function setupSearch() {
    ...
    function fetchRecipes(query) {
        ...
        return fetch(`https://api.spoonacular.com/recipes/autocomplete?number=5&query=${query}&apiKey=YOUR_API_KEY`)
